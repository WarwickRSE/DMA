...
#ifdef REPEAT
tri_repeating mat(len, 2, 2);
#else
banded_general_tri mat(len);
#endif

mat.fill_from_elemBanded(elementary_matrices::TriSpring);
...
thomas_solver solver;
solver.update_array(mat);
std::cout<<"Verifying LU decomposition\n";
...

{
  ...
  thomas_onthefly onthefly_solver;
